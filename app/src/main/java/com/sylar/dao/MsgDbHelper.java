	...
	private class SqlLiteHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			String sql = "CREATE TABLE  IF NOT EXISTS " + DB_NAME
						...
						"whos text,i_filed INTEGER,t_field text,Iswork INTEGER,serialnumber text,link text,issubmit INTEGER,parms text,Datas text,msgUrl text,isbit INTEGER,isRead INTEGER,bodyType text)";
			db.execSQL(sql);
