...
//				imageView, options_circle, animateFirstDisplayListener);
		...
		if (!bMap.containsKey(username)) {
			//VCard vCard = XmppUtils.getInstance().getUserInfo(username);
			VCard vCard = XmppConnection.getInstance().xmppConnection.getUserInfo(username, XmppConnection.getInstance());
			if (vCard != null) {
	...
	public static void initImageLoader() {
		...
		ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(
				ContextUtil.getInstance()).threadPriority(Thread.NORM_PRIORITY)
