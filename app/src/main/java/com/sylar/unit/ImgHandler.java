...
//			paint.setStrokeWidth(2);
	...
	public static Drawable ToCircular(int id) {
		BitmapDrawable drawable = new BitmapDrawable(null,
				ToCircular(drawableToBitmap(ContextUtil.getInstance().getResources().getDrawable(
						id))));
		return drawable;
	}
	...
	public static Drawable ToCircularBig(int id) {
		BitmapDrawable drawable = new BitmapDrawable(null, ToCircularBig(drawableToBitmap(ContextUtil.getInstance().getResources().getDrawable(id))));
		return drawable;
	}
	
	public static Drawable ToRect(int id) {
		BitmapDrawable drawable = new BitmapDrawable(null,
				ToRect(drawableToBitmap(ContextUtil.getInstance().getResources().getDrawable(id))));
		return drawable;
	}
