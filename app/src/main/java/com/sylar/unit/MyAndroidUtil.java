...
import com.sylar.ucmlmobile.MessageMain;
...
//	}
	 ...
	 * @param notiMsg
	 */
	public static void showNotification(String notiMsg) {
		String tickerText;
		//android推送
		if(notiMsg.contains(Constants.SAVE_IMG_PATH))
			tickerText = "[图片]";
...
//			tickerText = ExpressionUtil.getText(ContextUtil.getInstance(), StringUtil.Unicode2GBK(notiMsg));
		...
		Notification notification = new NotificationCompat.Builder(context)
				/**设置通知左边的大图标**/
				.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.logo114))
				/**设置通知右边的小图标**/
				...
				.setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, MessageMain.class), PendingIntent.FLAG_CANCEL_CURRENT))
				.build();
